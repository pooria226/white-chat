...
!(function (t, e) {
  ...
  function D(t, e) {
    e.useNativeTimers
      ...
      : ((t.setTimeoutFn = P.setTimeout.bind(P)),
  ...
  function Z() {}
  var tt = null != new G({ xdomain: !1 }).responseType,
    et = (function (t) {
      o(s, t);
      var n = p(s);
      function s(t) {
  ...
  function kt(t) {
    var e = [],
      ...
      r = t;
    return (
      (r.data = bt(n, e)), (r.attachments = e.length), { packet: r, buffers: e }
    );
  }
  function bt(e, n) {
    if (!e) return e;
          ...
          [
            {
              ...
              value: function (t) {
                ...
                if ("string" == typeof t) {
                  ...
                  n || e.type === Et.BINARY_ACK
                    ? ((e.type = n ? Et.EVENT : Et.ACK),
            ...
            value: function (t, e) {
              ...
              return (
                n
                  ...
                  : ((n = new St(this, t, e)), (this.nsps[t] = n)),
                n
              );
            },
          },
